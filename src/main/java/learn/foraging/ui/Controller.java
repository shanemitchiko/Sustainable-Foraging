...
public class Controller {
        ...
        do {
            ...
            switch (option) {
                ...
                case REPORT_KG_PER_ITEM:
                    reportKgPerItemByDay();
                    break;
                case REPORT_CATEGORY_VALUE:
                    reportTotalValuePerCategoryByDay();
                    break;
                case GENERATE:
                    generate();
                    break;
    ...
    private void reportKgPerItemByDay() throws DataException {
        LocalDate date = view.getForageDate();
    ...
    private void reportTotalValuePerCategoryByDay() throws DataException {
        LocalDate date = view.getForageDate();
        Map<Category, Double> categoryValueByDay = forageService.getCategoryValueByDay(date);
        view.displayReportCategoryValueByDay(categoryValueByDay);
    }
    ...
    private Forager getForagersByState() {
        String foragersByState = view.getForagerState();
        List<Forager> foragers = foragerService.findByState(foragersByState);
        return view.chooseForager(foragers);
    }
